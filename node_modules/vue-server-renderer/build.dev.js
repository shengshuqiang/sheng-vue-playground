...
function createRenderer$1({ modules = [], directives = {}, isUnaryTag = () => false, template, inject, cache, shouldPreload, shouldPrefetch, clientManifest, serializer } = {}) {
    ...
    return {
        renderToString(component, context, cb) {
            console.log('vue-server-renderer/build.dev.js#createRenderer$1#renderToString', component);
            ...
            try {
                ...
                render(component, write, context, err => {
                    console.log('vue-server-renderer/build.dev.js#createRenderer$1#renderToString#render#cb', component);
                    if (err) {
                        return cb(err);
                    }
